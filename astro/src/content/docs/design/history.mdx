...
For this scenario, the focus on the 1730s-1790s, delving into England's relationship with its American colonies. As with the original scenarioes, the perspective is from families of the British Empire, using the East India Company and the 13 Colonies to improve their financial and social status. The current working title is __1733: Tea & Business__.
...
- Tea &amp; Colonies
    - A play on the phrase "tea and sympathy".
    - More straightforward as to what it's referring to.
- Tea &amp; Liberty
    - A play on the phrase "tea and sympathy".
    - The downside of using the word "liberty" is that it implies a perspective coming from America, as opposed to Britain.
:::
...
This scenario is designed to be a different lens on the story that John Company: Second Edition is trying to tell. It zooms out a bit, focusing more on the government and how the EIC interoperated with British trade in the 13 colonies. It focuses on Tea because of the British and America obsession with Tea during the 18th century, which raises the importance of the Chinese trade.
...
:::caution
This is not a scenario about the American Revolutionary War itself. While the events leading up to the war are focused on (various tariffs, "taxation without representation", etc), the military action in America is not a focus, similar to how the various wars in India during this time are only referenced. Those wanting to play a scenario specifically about the American Revolutionary War will likely be disappointed.
:::

## India

While there is a focus on the 13 colonies, the game is still primarily about the East India Company and the British Empire. India still has a large place in the game and all of the laws and events from the original scenarios are available, aside from deregulation.
...
From a gameplay perspective, the starting state of India will be similar to the __1758__ scenario. The initial focus is placed on events that occurred during the 1730s and 1740s (namely the Carnatic Wars). Every other scenario has 7 of the 17 orders closed at the start, so a decision was made to match that number.
...
2. The [Carnatic Wars](https://en.wikipedia.org/wiki/Carnatic_wars) were fought on the southeastern side of India during the mid-to-late 1740s (which roughly corresponds between Turn 2-3 during the game). On the John Company map of India, this is depicted by the regions of ___Hyderabad___ and ___Madras___.
    ...
    :::caution[Argument]
    It can be argued that the £6 order in __Mysore__ should be closed instead of the £2 order in __Maratha__. This would exactly match the initial setup of the __1758__ scenario, so the current decision is to provide a little variety.

    The downside of this choice is that the trade orders for the Bombay Presidency are wide open and unchallenged, while the Bengal Presidency is restricted and the Madras Presidency is fully closed. Narratively, we want to motivate the Company to be involved in the eastern side of India, where the export icons are. So, this difference is setup might be a poor choice. Playtesting will be very important here.
    :::
...
4. ___Mysore___ was weaker due to inner conflict before Hyder Ali took over in the 1760s. As a result, the choice was made to keep their region strength at 1.
