...
:::note
A work like this where the "East Indians" and "West Indians" are being discussed can easily cause confusion. Since discussion around the term "Indians" should rightfully apply to those of the country of India, the term "Natives" will be used to represent the indigenous people in North America.

The term is derogatory, but, sadly, makes sense given the arrogance of that both the British and the American Colonists displayed to the indigenous peoples of North America. It is reasonable to argue that there isn't much difference in how the EIC treated the people of India and how the ambitious Colonists treated the Native Americans.
:::
...
- India is shaped like a triangle or a kite, while the original 13 colonies are shaped like a thin rectangle. This shape is tricky, as it constricts the trade routes and the pathing between them. The resulting geometry is less interesting.
    - This is a reason to potentially add additional trading space [outside the colonies](#other-regions-and-locations).
...
The Chesapeake was also the most populated colonies, allowing for more importing of British goods. In terms of the [estimated Colonial population](https://www2.census.gov/library/publications/1909/decennial/century-populaton-growth-part02.pdf), the regions had the following population (including slaves):
...
:::note
It should be noted that the shipbuilding in New England was vital and became a major source of shipbuilding. Accounting for that in the game is important. 
:::
...
Ohio is especially interesting considering the amount of [Land Companies](../economy#land-companies) which issued shares for the land in the region. A similar thought can be given for the Mississippi Territory.

### Quebec and Florida

The territories of Quebec and Florida became a large issue for the 13 colonies, notably during the French and Indian War and the War of Jenkins Ear, respectively. These are additional areas whose orders could be closed and provide targets for the British military to open them.
...
In addition, all of the West Indies are islands and thus would be seaports. Additional rules or considerations would be needed to support them.
- Jamaica
- Barbados (and the Westward Islands)
- Leeward Islands
- Bahama Islands

However, on the map, this does become an area to represent the Dutch and French West Indies in terms of [smugglers](../tension#smugglers-and-colonial-merchants). Having their strength (or other representation) would be thematic and logical.
