...
The term is slightly derogatory, but also makes sense given the arrogance of both the British and the Colonists display to the indigenous peoples of North America.
:::
...
- India is shaped like a triangle or a kite, while the 13 colonies are shaped like a thin rectangle. This shape is tricky, as it constricts the trade routes and the pathing between them. The resulting geometry is less interesting.
    - This is a reason to potentially add additional trading space outside the colonies.
...
## Other Possible Regions and Locations
...
However, on the map, this does become an area to represent the Dutch and French West Indies in terms of smugglers. Having their strength (or other representation) would be thematic and logical.
