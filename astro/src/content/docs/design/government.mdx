...
:::note
There is a potential confusion around the word "office", as the positions in the Company are referred to both as "offices" and "officeholders" in the rules. Naming this the "Colonial Department" is historically incorrect, but might be a better name from a rules/gameplay perspective.
:::
...
:::note
Historically, the Board of Trade and Plantations did provide Parliament with advice and recommendations about both laws in the Colonies and worked along with the Treasury Board and the Chancellor of the Exchequer to establishes tariffs and other colonial taxes.
:::
...
:::caution[Warning]
Unlike a President, the {frontmatter._["role.govt.governor"]} doesn't have any direct financial incentives, other than pure negotiation. Some playtesting will need to determine if some direct incentive is needed for this position, other than what can be negotiated.

One thought is to make this position responsible for the hiring of the other positions in the {frontmatter._['role.govt.office']}, to provide them with more authority.
:::

### British Military

The __{frontmatter._["role.govt.military.full"]}__ is a combination of the Commander of the British Army and Navy for North America. It functions similarly to the other Commanders, spending regiments to obtain dice to roll in offensive maneuvers. The {frontmatter._["role.govt.military"]} can also local alliances, assuming the {frontmatter._["role.govt.governor"]} allocates the funds.
...
Both the Colonists (in the form of both local militia and privateers) and various Native American tribes should be available as local alliances to be hired. This allows us to utilize the mechanics of the Company, while also matching history. The British Army was not as effective fighting in the wilderness of North America as either the Colonists or Native Americans were.
...
The customs officers were not popular in North America and the position was risky. There are many examples of officers abandoning their post after pushback or retribution from the colonists. This office could start with an attrition cube (like the Chairman), or have some other mechanism in place to represent that risk.
:::
...
The {frontmatter._["role.govt.tariffs"]} would be selected by the Prime Minister and would be responsible for hiring the {frontmatter._["role.govt.governor"]}. Similar to the Prime Minister, the {frontmatter._["role.govt.tariffs"]} never retires and does not roll for attrition.
...
- There are only 2-3 total positions that could hire from the pensioners. If one is not open, then pensioners act like they always have.

This is worth playtesting and the idea should be be thrown out if it removes too much retirement tension.
:::

Hiring for the {frontmatter._["role.govt.customs"]} could also use the pensioners, although negotiatiation should be encouraged, with the {frontmatter._["role.govt.governor"]} benefiting.
Both the {frontmatter._["role.govt.governor"]} and the {frontmatter._["role.govt.customs"]} officeholders can retire, just like the Company officeholders.
...
As stated, one of the goals of the {frontmatter._["role.govt.office"]} is to have it contrast with the Company Presidencies. The changes should highlight both the similarities and differences between the Company and the Government. The hope is that it feels familiar and still flows relatively quickly.
...
One of the questions of the design is how far to lean in this direction. If these positions are "too close but not quite" to their India counterpart, this could really slow the game down.
