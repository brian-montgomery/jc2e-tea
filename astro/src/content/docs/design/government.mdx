...
:::danger[Warning]
One of the questions of the design is how far to lean in this direction. If these positions are "too close but not quite" to their India counterpart, this could slow the game down. This fourth presidency shouldn't take so long that it is the length of the Indian presidencies combined.
:::
