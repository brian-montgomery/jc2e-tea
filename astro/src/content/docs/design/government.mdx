...
:::tip[Alternate Names]{icon="approve-check-circle"}
...
:::tip[A direct financial reward*]{icon="approve-check-circle"}
...
:::tip[Flavor: A risky position]{icon="approve-check-circle"}
