...
- {frontmatter._["tea.token.plural"]} (use poker chips).
- Debt Markers (use red cubes).
- Office Cards for 1733.
- Office overlay for {frontmatter._["role.company.tea2"]}.
- {frontmatter._["deck.laws.plural"]} Deck.
- Events in America Deck.
- A couple of pawns for the {frontmatter._["tea.track"]} and {frontmatter._["credit.track"]} tracks.
...
1. Place the scenario board next to the main board (preferably on the left).
